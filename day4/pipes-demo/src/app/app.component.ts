   ...
   <!--     <div style="text-align:center" class="content">
        ...
        <div>
            <mat-card>
                ...
                <mat-card-content>
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ipsum iste magnam maxime molestiae quae, quasi vitae! Cum dicta facere impedit mollitia nisi quibusdam reiciendis unde! Asperiores culpa dolorem ea earum explicabo, facilis itaque laborum nihil, quasi quibusdam repellat sunt vero.
                </mat-card-content>
            </mat-card>
...
export class AppComponent {
    ...
    description: string = `It's a :rocket: :snowboarder:  :tea: :wink:`;
